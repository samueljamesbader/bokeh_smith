...
def smith_chart(
    ...
    p.ellipse(x=a / (a + 1), y=0, width=2 / (a + 1), height=2 / (a + 1), fill_color=None, line_color='black',
                 line_width=.5)
    ...
    p.ellipse(x=1, y=1 / b, width=2 / b, height=2 / b, fill_color=None, line_color='black', line_width=.5)
    p.line([-1, 1], [0, 0], line_color='black', line_width=.5)
